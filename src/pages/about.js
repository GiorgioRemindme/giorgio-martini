...
const IndexPage = () => (
    <div className="">
        ...
        <div className="pt1">
          ...
          <p className="f3 white">I also love to create Art with <Link className="_pink" to='/code/'>code</Link>, making <Link className="_pink" to='/code/'>music</Link> and taking <Link className="_pink" to='/code/'>pics</Link>.
