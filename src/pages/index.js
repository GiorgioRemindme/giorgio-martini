...
const IndexPage = () => (
    <div className="">
        ...
        <Layout>
        <div className="pt4">
          <p className="lh-title">Hey!</p>
          <p className="lh-title">I'm a Berlin based web developer with a passion for music.</p>
          <p className="lh-title">I love creating stuff with
          ...
          <p className="lh-title">You can find me on
